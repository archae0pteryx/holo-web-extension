...
export default () => test("entry_def_0 CRUD tests", async (t) => {
  await runScenario(async scenario => {
    ...
    const createInput = {
  "title": "We to they",
  "content": "AM/FM radio, reclining bucket seats, and power windows. I travel for work, but recently, friends said I should take major trips. I love to be directed."
};
    ...
    const contentUpdate = {
  "title": "on your should",
  "content": "They're using our own satellites against us. What do they got in there? What do they got in there?"
}
